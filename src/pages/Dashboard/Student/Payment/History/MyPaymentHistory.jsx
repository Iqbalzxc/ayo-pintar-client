...
const MyPaymentHistory = () => {
  ...
  return (
    <div className="p-4">
      <div className="text-center mt-24 md:mt-6 mb-16">
        <h1 className="text-4xl font-bold">
          Riwayat <span className="text-secondary">Pembayaranku</span>
        </h1>
        <p className="text-gray-500 text-sm my-3">
          Hai,{" "}
          <span className="text-secondary font-bold">{currentUser.name}</span>{" "}
          kamu bisa melihat riwayat pembayaran disini
        </p>
      </div>
      ...
      <div className="overflow-x-auto">
        <div className="mb-4">
          ...
          <p className="font-bold text-center">
            Total Bayar: {formatCurrency(totalPaidAmount)}
          </p>
        </div>
