...
const ApprovedClass = () => {
  ...
  return (
    <div className="container mx-auto px-4">
      <div className='my-9'>
        <h1 className='text-4xl font-bold text-center'>Kelas <span className='text-secondary'>Disetujui</span></h1>
        <div>
          <p className='text-[12px] text-center my-2'>Kamu bisa melihat semua kelas yang telah disetujui disini</p>
        </div>
      </div>

      <div>
        {classes.length === 0 ? (
          <div className='text-center text-2xl font-bold mt-10'>Tidak ada kelas yang disetujui</div>
        ) : (
          <div>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                      <div>
                        ...
                        <h1 className='text-secondary my-2'>
                          ...
                          <span className={`font-bold ${cls.status === "approved" ? "text-green-500" : "text-red-600"}`}>
                            {cls.status}
                          </span>
                        </h1>
                      </div>
